jQuery.fn.wowSlider = function(am) {
    ...
    window.ws_basic = function(k, c, f) {
        var a0 = aI(this);
        this.go = function(a1) {
            f.find(".ws_list").css("transform", "translate3d(0,0,0)").stop(!0).animate({
    ...
    function I() {
        ...
        function a5(bm) {
            ...
            for (var bl = 0; bl < 2; bl++) {
                if (bl) {
                    var bp = bf.find("> a");
                    var bk = ag ? bf.width() : aI(bp.get(0)).outerWidth(!0) * bp.length
                } else {
                    var bk = bf.height()
                }
        ...
        if (ao.length) {
            ...
            if (am.gestures) {
                ...
                aB(ao, am.gestures == 2, function(bk, bh, bg) {
                    ...
                    a7 = ao.width();
                    be = ao.height();
                    a6 = aI(bh.get(0)).outerWidth(!0) * bh.length;
                    bd = bf.height();
        ...
        if (ay.length) {
            ...
            if (a1.length) {
                ...
                function bc(bi) {
                    ...
                    var bh = a1.get(bi);
                    var bg = {
                        left: -bh.offsetLeft + (aI(bh).outerWidth(!0) - aI(bh).outerWidth()) / 2
                    };
                    if (a4 < 0) {
                        a3.css(bj);
                        a9.css(bg)
            ...
            if (a3 == c) {
                ...
                if (!aw) {
                    ...
                    for (var a1 = 0; a1 <= 1; a1++) {
                        if (a1) {
                            var a4 = a5.find("> a");
                            var a0 = ag ? a5.width() : aI(a4.get(0)).outerWidth(!0) * a4.length
                        } else {
                            var a0 = a5.height()
                        }
                        ...
                        if (f < 0) {
                            if (a1) {
                                a5.stop(!0).animate({
                                    left: -Math.max(Math.min(a2.left, -a6.left), a2.left + k.outerWidth(!0) - ao.width())
                                })
                            } else {
                                a5.stop(!0).animate({
                                    top: -Math.max(Math.min(a2.top, 0), a2.top + k.outerHeight(!0) - ao.height())
                                })
                            }
                        } else {
