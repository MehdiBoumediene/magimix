...
DataTable.ext.buttons.copyHtml5 = {
	...
	action: function ( e, dt, button, config ) {
		...
		if ( document.queryCommandSupported('Copier') ) {
		...
		var message = $('<span>'+dt.i18n( 'buttons.copyKeys',
				'appuyez sur <i>ctrl</i> + <i>C</i> pour copier les données<br>à votre presse-papiers <br><br>'+
				'Pour annuler , cliquez sur ce message ou appuyez sur Echap.' )+'</span>'
			)
			.append( hiddenDiv );

		dt.buttons.info( dt.i18n( 'buttons.copyTitle', 'Copier dans le presse-papier' ), message, 0 );
